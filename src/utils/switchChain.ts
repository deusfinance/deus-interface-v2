...
import { networkConnection, walletConnectConnectionV1, walletConnectConnectionV2 } from 'connection'
...
export const switchChain = async (connector: Connector, chainId: SupportedChainId) => {
  if (!isSupportedChain(chainId)) {
    ...
    connector === walletConnectConnectionV1.connector ||
    ...
    const addChainParameter = {
      chainId: Number(chainId.toString()).toString(16),
